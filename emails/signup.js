...
function signupEmail(data) {
    ...
    <div style="text-align: center; margin: 10px auto">
     ...
     <div style="padding: 20px; background: rgba(255, 255, 255, 1)">
         ...
         <p style="text-align: center; text-transform: uppercase; letter-spacing: 0.5px; font-weight: bolder; font-size: 15px; color: rgba(34, 34, 34, 1)">New Password</p>

         <hr style="border-width: 1px; border-color: rgba(189, 150, 94, 1)">

         <p style="font-size: 14px; color: rgba(68, 68, 68, 1)"> Dear  ${data.name},</p>

         <p style="font-size: 14px; color: rgba(68, 68, 68, 1)">Please kindly provide your approval for publish the review</p>
